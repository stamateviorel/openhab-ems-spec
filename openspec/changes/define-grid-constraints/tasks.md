...
- [ ] 2.1 Formalize the budget/priority interaction with wave-1 priorities (one ordering, not two)
- [ ] 2.2 Peak-tracking semantics across restarts (persisted state)

## 3. Prototype path

- [ ] 3.1 Bucket-peak tracker as a pure function with the Belgian parameters as test vectors
- [ ] 3.2 Budget scheduler over the thread's 3 kW + 9 kW example
