...
**Wave 2** — the non-price half of "a mechanism to store future prices _and e.g. also
weather forecast data_" (Kai's need #1).
...
that. The 2026 discussion added the unifying corollary: _derived demand_ (like heating
